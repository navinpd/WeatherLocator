...
public class TestCityQueryViewModel {
    ...
    @Test
    /*
    Test when local data is queried then we calculate the correct city or not
     */
    public void _02_TestUpdateLocallySavedList() throws InterruptedException {
        ...
        when(sharedPreferences.getString("Constants.LOCAL_LIST", ""))
                .thenReturn("{\"CityData\": [{\"cityName\": \"Thana-India \",\"timeStamp\":\"1580810233667\"}]}");
    ...
    @Test
    /*
    Test when local data is empty then we calculate the correct city or not
     */
...
//                .thenReturn(results);
//
//        doReturn(results).when(results.subscribeOn(Schedulers.io()));
//
//        doAnswer(new Answer() {
//            @Override
